...
int main(int argc, char** argv) {
    ...
    cout<<"Banks Savings 6                      = $"<<save6(pv,i,nCmpd)<<endl;
    cout<<"The Peoples Banks Savings 7          = $"<<save7(pv,i,nCmpd)<<endl;
    cout<<"The More Peoples Banks Savings 8     = $"<<save8(pv,i,nCmpd)<<endl;
